...
**BCLD Version**: 13.4-7 BCLD (Elysium)
...
| 2   | bcld.afname.shutdown             | Shutdown timer                                                  | *HOURS*                 | **0**, 1                                                                                                         |
| 3   | bcld.afname.url                  | Web site target                                                 | *URL*                   | https://ac2-afname.test-facet.onl/                                                                               |
| 4   | bcld.afname.vendor               | BCLD Vendor                                                     | *VENDOR*                | **facet**, wft                                                                                       |
| 5   | bcld.afname.verbose              | Increase verbosity                                              | *BIT*                   | **0**, 1                                                                                                         |
| 6   | bcld.afname.zoom                 | Enable BCLD Zoom functionality.                                 | *BIT*                   | **0**, 1                                                                                                         |
|     |                                  |                                                                 |                         |                                                                                                                  |
|     | **DISPLAY**                      |                                                                 |                         |                                                                                                                  |
| 7   | bcld.display.brightness          | Brightness                                                      | *PERCENTAGE*            | 10 - **100**                                                                                                     |
| 8   | bcld.display.preset              | Dimensional presets:                                            | *PRESET*                | - 4K (UHDTV met HDPI)<br/> - 1080p (Full HD)<br/> - HD+ (1600×900)<br/> - 768p (1368x768)<br/> - XGA (1280x1024) |
| 9   | bcld.display.resolution          | Resolution                                                      | *RESOLUTION*            | 1280x1024, 1368x768, 1600×900, 1920x1080                                                                         |
| 10  | bcld.display.rotate              | Rotation                                                        | *STRING*                | left, right, **normal**, inverted                                                                                |
| 11  | bcld.display.scale_factor        | Scaling                                                         | *PERCENTAGE*            | 10 - 200, **100**                                                                                                |
|     |                                  |                                                                 |                         |                                                                                                                  |
|     | **AUDIO**                        |                                                                 |                         |                                                                                                                  |
| 12  | bcld.audio.alsa_port             | Port Name                                                       | *PERCENTAGE*            | 10 - **100**                                                                                                     |
| 13  | bcld.audio.alsa_sink             | Sink Name                                                       | *PERCENTAGE*            | 10 - **150**                                                                                                     |
| 14  | bcld.audio.default_playback_vol  | Output Volume                                                   | *PERCENTAGE*            | 10 - **100**                                                                                                     |
| 15  | bcld.audio.default_recording_vol | Recording Volume                                                | *PERCENTAGE*            | 10 - **150**                                                                                                     |
| 16  | bcld.audio.default_sink          | Default audio output device                                     | *DEVICE INDEX*          | 1, 2, ...                                                                                                        |
| 17  | bcld.audio.default_source        | Default audio input device                                      | *DEVICE INDEX*          | 1, 2, ...                                                                                                        |
| 18  | bcld.audio.restore               | Set ALSA Restore                                                | *BIT*                   | **0**, 1                                                                                                         |
| 19  | bcld.audio.use_combined_sink     | Combined audio devices                                          | *BIT*                   | **0**, 1                                                                                                         |
|     |                                  |                                                                 |                         |                                                                                                                  |
|     | **NETWORK**                      |                                                                 |                         |                                                                                                                  |
| 20  | bcld.default.interface           | Standard network adapter                                        | *INTERFACE*             | enp0s1                                                                                                           |
| 21  | bcld.realtek.driver              | Selected Realtek driver                                         | *KERNEL MODULE*         | r8168                                                                                                            |
| 22  | bcld.wifi.eap.auth               | Wi-Fi EAP authentication method                                 | *AUTHENTICATION METHOD* | mschap, **mschapv2**                                                                                             |
| 23  | bcld.wifi.eap.method             | Wi-Fi EAP method                                                | *EAP METHOD*            | tls, ttls                                                                                                        |
| 24  | bcld.wifi.eap.user               | Wi-Fi user (with domain) for EAP                                | *BASE64 USER[@DOMAIN]*  | jan, jan@duo.nl                                                                                                  |
| 25  | bcld.wifi.eap.password           | Wi-Fi password for EAP                                          | *BASE64 PASSWORD*       | bm90aGluZ2J1dHVzY2hpY2tlbnMK                                                                                     |
| 26  | bcld.wifi.psk                    | Wi-Fi password                                                  | *BASE64 STRING*         | bm90aGluZ2J1dHVzY2hpY2tlbnMK                                                                                     |
| 27  | bcld.wifi.ssid                   | Wi-Fi name                                                      | *BASE64 SSID*           | UXVpbnRvckdhc3QK                                                                                                 |
| 28  | bcld.wol.disable                 | Wake-on-LAN                                                     | *BIT*                   | **0**, 1                                                                                                         |
| 29  | bcld.wwan.enable                 | 4G, 5G, LTE                                                     | *BIT*                   | **0**, 1                                                                                                         |
|     |                                  |                                                                 |                         |                                                                                                                  |
|     | **KERNEL**                       |                                                                 |                         |                                                                                                                  |
| 30  | acpi                             | Advanced Configuration and Power Interface                      | *SWITCH*                | **on**, off                                                                                                      |
| 31  | ipv6.disable                     | Disable IPv6 networking                                         | *BIT*                   | **0**, 1                                                                                                         |
| 32  | nomodeset                        | Instruction to leave the kernel's mode setting to the firmware. | KERNEL PARAM            | nomodeset                                                                                                        |
| 33  | nouveau.modeset                  | Allows kernel from loading video driver                         | *BIT*                   | 0, **1**                                                                                                         |
| 34  | snd_hda_intel.dmic_detect        | Enables integrated microphone detection to force audio.         | *BIT*                   | 0, **1**                                                                                                         |
